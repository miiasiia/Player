...
void PlayerAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String PlayerAudioProcessor::getProgramName (int index)
{
    return {};
}

void PlayerAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void PlayerAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
//==============================================================================
void PlayerAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void PlayerAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
